      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="dropdown">
              <a  href="index.php#classes"><i class="fa fa-calendar" style="padding-top:7%;font-size:18px;"></i> Classes <i class="fa fa-caret-down"></i></a>
            ...
            <li class="dropdown">
              <a href="index.php#facilities"><i class="material-icons" style="padding-top:5%;font-size:18px;">fitness_center</i> Facilities <i class="fa fa-caret-down"></i></a>
                 <div class="dropdown-content">
