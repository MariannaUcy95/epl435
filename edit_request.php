...
<html lang="en">
  ...
  background-size: cover;">
		...
		<h4 style="padding-top:50px; text-align:left;">Glutes &amp; Legs</h4>
			...
			<br>
              ...
              <br>
				...
				<br>
				<br>
		    <button class="btn btn-default"  type="submit" id="makeform">Next</button>
    ...
    <footer >
        <center>
        <div id="footer">
           <center> <img src="images/img_black.png" style="width:200px;"> </center>
            <br>
            <br>
